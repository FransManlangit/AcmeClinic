...
@section('body')
 ...
 <div class="jumbotron">
  ...
  <a href="#" class="btn btn-success btn-sm" data-toggle="modal" data-target="#customerModal"><strong><i class="fas fa-plus"></i> Add New Customer</strong></a>
  </div>
 <div class="col-xs-6">
...
<div class="modal" id="customerModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="col-md-3 mb-3">
      ...
      <input type="text" class="form-control" id="town" name="town" placeholder="State" required>
      <div class="invalid-feedback">
